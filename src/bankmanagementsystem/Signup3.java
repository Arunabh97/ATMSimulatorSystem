...
public class Signup3 extends JFrame implements ActionListener{
    ...
    JLabel lh,l1,l2,l3,l4,l5,l6,l7,l8,l9,l10,l11;
    ...
    Signup3(String formno) {
       ...
       lh = new JLabel("Page3: Account Details");
       lh.setFont(new Font("Raleway", Font.BOLD, 22));
       lh.setBounds(280,40,400,40);
       add(lh);
    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        String cardnumber = "" + Math.abs(number);
        
        long number2 = (ran.nextLong() % 9000L) + 1000L;
        String pin = "" + Math.abs(number2);
        ...
        try{
            if(ae.getSource()==b1){
                ...
                JOptionPane.showMessageDialog(null, "Fill all the required fields");
                    ...
                    Conn c1 = new Conn();
                    String q1 = "Insert into signupthree value('"+formno+"','"+atype+"','"+cardnumber+"','"+pin+"','"+facility+"')";
